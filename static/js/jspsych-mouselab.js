    ...
    function render_table(costs,values,clicks,make_clickable,color_cost_dict,show_all){
          ...
          if (make_clickable){
              ...
              $(".covered").click(function() {
                  ...
                  data.click_cost += get_cost(curr_row, curr_col)
                  render_table(costs,values,data.clicks,true,color_cost_dict)
              });
      ...
      render_table(trial.cost_matrix,trial.payoff_matrix,data.clicks,clickable,color_dict,0)
      if (trial.question) {
